# 4-year, 2-year Colleges and Trade Schools Access Scores in VA
# packages
library(tigris)
library(sf)
library(dplyr)
...
out_df_4year <- left_join(out_df_4year, counties_names, by=c("geoid"))
out_df_2year <- left_join(out_df_2year, counties_names, by=c("geoid"))
out_df_less2 <- left_join(out_df_less2, counties_names, by=c("geoid"))
...
dbWriteTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_4year_colleges"),
             df_long_4year,  row.names = F)
dbWriteTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_2year_colleges"),
             df_long_2year,  row.names = F)
dbWriteTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_trade_schools"),
             df_long_less2,  row.names = F)

# dbRemoveTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_4year_colleges"))
# dbRemoveTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_2year_colleges"))
# dbRemoveTable(con, c("dc_education_training", "va_ct_osrm_2021_drive_times_nearest_trade_schools"))

dbSendStatement(con, "ALTER TABLE dc_education_training.va_ct_osrm_2021_drive_times_nearest_4year_colleges
                    OWNER TO data_commons")
dbSendStatement(con, "ALTER TABLE dc_education_training.va_ct_osrm_2021_drive_times_nearest_2year_colleges
                    OWNER TO data_commons")
dbSendStatement(con, "ALTER TABLE dc_education_training.va_ct_osrm_2021_drive_times_nearest_trade_schools
                    OWNER TO data_commons")
...
# add region names
out_df_4year <- left_join(df3_4year, counties_names, by=c("GEOID"="geoid"))
out_df_2year <- left_join(df3_2year, counties_names, by=c("GEOID"="geoid"))
out_df_less2 <- left_join(df3_less2, counties_names, by=c("GEOID"="geoid"))
